...
```
The training performance is not fully reproduced yet, so I recommended to use alex's Darknet to train your own data and convert your .weights to tensorflow or tflite.
