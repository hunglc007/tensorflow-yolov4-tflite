...
import core.component.backbone as backbone
import core.component.common as common
import core.component.head as head
import core.component.neck as neck
...
def YOLOv4(input_layer, NUM_CLASS):
    ...
    # Neck
    route_1, route_2, conv, shortcut = neck.yolov4_neck(route_1, route_2, conv)

    # Head
    conv_sbbox, conv_mbbox, conv_lbbox = head.yolov3_head(route_1, route_2, conv, shortcut, NUM_CLASS)
